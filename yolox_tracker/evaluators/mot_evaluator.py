...
from yolox_tracker.utils import (
    gather,
    is_main_process,
    postprocess,
    synchronize,
...
from yolox_tracker.sort_tracker.sort import Sort
from yolox_tracker.deepsort_tracker.deepsort import DeepSort
from yolox_tracker.motdt_tracker.motdt_tracker import OnlineTracker
...
class MOTEvaluator:
    ...
    def evaluate_prediction(self, data_dict, statistics):
        ...
        if len(data_dict) > 0:
            ...
            '''
            try:
                from yolox_tracker.layers import COCOeval_opt as COCOeval
            except ImportError:
